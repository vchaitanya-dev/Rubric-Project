...
export const userSlice = createSlice({
     ...
     reducers:{
          ...
          chirpFilter:(state,action:PayloadAction<number>) => {
               ...
               state.users = users},
          startFilter:(state,action:PayloadAction<number>) => {
               const filterNumber = action.payload;
               const users = state.users.filter((item) => item.join_date === filterNumber);
               state.users = users},
     }
})

export const {getUser,removeUser,totalFilter,friendFilter,influenceFilters,chirpFilter,startFilter} = userSlice.actions
